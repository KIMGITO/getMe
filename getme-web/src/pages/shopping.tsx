...
export default function IntegratedOrderPage() {
  ...
  return (
      ...
      <div className="flex h-[100dvh] flex-col  h-full max-w-4xl w-full mx-auto bg-surface-container-lowest text-on-surface  elevation-5 my-4 rounded-2xl overflow-hidden font-sans antialiased">
